...
namespace Unity.Networking
{
    ...
    class BackgroundDownloadiOS : BackgroundDownload
    {
        ...
        protected override int GetReceivedBytes() {
            if (_backend == IntPtr.Zero)
                return -1;
            return UnityBackgroundDownloadGetReceivedBytes(_backend);
        }
        ...
        [DllImport("__Internal")]
        static extern int UnityBackgroundDownloadGetReceivedBytes(IntPtr backend);
